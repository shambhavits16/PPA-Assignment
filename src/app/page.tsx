...
///completed task 1: by using tailwind css, nextJS, Zustand, ShadCN
///completed task 2: made a toggle between dark and light mode
///completed task 3: made it responsive on all screens
///completed task 4: added a working carousel for the first section
///completed task 5: Add a "count-up animation"